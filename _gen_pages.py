...
{{"@context":"https://schema.org","@type":"WebSite","name":"Agnes Mortgage","url":"{BASE}"}}
    ...
    cards = [
        ("buy-to-let", "svc-buy-to-let.jpg",
         ("Buy-to-Let & Portfolio", "Buy-to-Let & Portfolio", "Buy-to-Let y carteras", "Buy-to-let és portfólió"),
        ...
        ("hmo-finance", "svc-hmo.jpg",
         ("HMO & Multi-Unit Finance", "HMO & Mehrfamilienobjekte", "HMO y multiunidad", "HMO és többlakásos finanszírozás"),
        ...
        ("expat-mortgages", "svc-expat.jpg",
         ("Expat & Overseas Mortgages", "Expats & Auslandskunden", "Expatriados y no residentes", "Külföldön élők jelzáloghitele"),
...
def build_all_services():
    build_service(
        "buy-to-let", "svc-buy-to-let.jpg",
        "Buy-to-Let & Portfolio Landlord Mortgages UK | Agnes Mortgage",
        ...
        ("Buy-to-Let & Portfolio Landlord Mortgages", "Buy-to-Let & Portfolio-Finanzierung", "Hipotecas Buy-to-Let y de cartera", "Buy-to-let és portfólió-jelzáloghitelek"),
    ...
    build_service(
        "hmo-finance", "svc-hmo.jpg",
        "HMO Mortgages & Multi-Unit Finance UK | Agnes Mortgage",
        ...
        ("HMO & Multi-Unit Finance", "HMO & Mehrfamilienobjekte", "Financiación HMO y multiunidad", "HMO és többlakásos finanszírozás"),
...
def build_remaining_services():
    build_service(
        "expat-mortgages", "svc-expat.jpg",
        "Expat & Overseas Buyer Mortgages UK | Agnes Mortgage",
        ...
        ("Expat & Overseas Mortgages", "Expat- & Auslandsfinanzierung", "Hipotecas para expatriados", "Jelzáloghitel külföldön élőknek"),
